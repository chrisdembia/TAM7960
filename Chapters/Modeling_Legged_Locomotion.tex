...
\end{centering}
\caption[Diagram: Energy Accounting]{Energy accounting: for a system of masses like the particles shown in this figure, the center of mass of the system can be described in any reference frame. Here, by using two different reference frames, point $C$ and the origin $O$, it can be shown that the linear momentum of the system is the sum of the linear momenta of the elements of the system.}
...
One way to model locomotion is by assuming the entire body is a point mass. This is a useful way to model a human because this assumption greatly reduces the complexity of the equations of motion needed to describe human locomotion. The model may also be accurate to a certain degree; a human's legs account for about only 44\% of the mass of the body \cite{winter92}. \todo[inline]{Chris: 44\% doesn't sound too low} We focus only on simple and abstract expressions for the energy interactions of the motion, as the motion itself is basic. \todo[inline]{Alan: this last sentence could use some clarification} 
...
\begin{figure}[h]		% h="here" t="top" b="bottom" p="separate page"
\begin{centering}
\subfloat[]{\includegraphics[width=0.4\textwidth]{Figures/Hodograph}\label{fig:Hodograph}}
\subfloat[]{\includegraphics[width=0.25\textwidth]{Figures/StepTransition}\label{fig:StepTransition}}
\subfloat[]{\includegraphics[width=0.25\textwidth]{Figures/ForcesFollowCircle}\label{fig:ForcesFollowCircle}}
\end{centering}
