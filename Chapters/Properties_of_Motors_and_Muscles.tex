...
where $k$ represents the motor torque constant, which has units of \unitfrac{Nm}{Amp}. Substitution of equation \ref{eq:MotorTorque} into equation \ref{eq:EnergyConservation}, gives the motor voltage law:
...
These equations \ref{eq:MotorAndGearbox} neglect the presence of friction in the gearbox.
